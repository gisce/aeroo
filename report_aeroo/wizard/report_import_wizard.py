...
from report_actions import ir_set
...
class report_aeroo_import(osv.osv_memory):
    ...
    def install_report(self, cr, uid, ids, context=None):
        ...
        res = ir_set(cr, uid, 'action', 'client_print_multi', report.report_name, [report.model], 'ir.actions.report.xml,%d' % report_id, isobject=True)
